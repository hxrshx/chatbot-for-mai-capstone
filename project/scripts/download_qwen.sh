#!/bin/bash
"""
Download Qwen2.5-1.5B-Instruct model locally
...
echo "============================================================"
echo "This will download ~3GB of model files"
echo "Model will be saved to: ./models/qwen2.5-1.5b"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo "📁 Location: ./models/qwen2.5-1.5b"
    echo ""
